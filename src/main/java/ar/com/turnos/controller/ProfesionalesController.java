...
public class ProfesionalesController {
    ...
    public Profesionales get(@PathVariable Integer id)
    {return entityService.get(id);}

    @GetMapping(path = "/profesionales/search/{expresion}")
    public List<Profesionales> getListProfesionales(@PathVariable String expresion)
    {return entityService.findByApellido(expresion);}
